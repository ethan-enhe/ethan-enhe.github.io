...
### 60分
观察数据特点：f(k)<1，我们可以利用这点来优化我们的dp，即：在转移时只转移喜欢 C[i] 这个颜色的那个商家即可，这个思路也给正解打下了基础。

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTAxMTgyMjMsLTY1NDQyMjQwMSwxOD
gwODQ3MjE3LDY1MzAwNzU5NSw0OTQxNzk2MTAsMTk0NTg2NTAy
Myw4MDgxODQwNDJdfQ==
-->